...
//here they have checked it as increasing decreasing and then again increasing instead of doing that we can also compare it to the mountain problem where we just check
//how many peaks are availale there and if more than one peak is found that it is not possible this approach is also sort of similar to that one
